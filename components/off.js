    ...
    <section className="max-w-sm mt-2 md:max-w-2xl lg:max-w-7xl m-auto">
      <div className="grid grid-cols-4 place-items-center">
        <div className="h-auto w-auto md:w-44 lg:w-56">
          <div className="p-1 h-24 bg-yellow-300 md:p-2  md:grid md:place-items-center">
            <img
        ...
        <div className="h-auto w-auto md:w-44 lg:w-56">
          <div className="p-1 h-24 bg-red-600 md:p-2  md:grid md:place-items-center">
            <img
              className="h-full w-full object-contain"
              loading="lazy"
              alt="category-picture"
        ...
        <div className="h-auto w-auto md:w-44 lg:w-56">
          <div className="p-1 h-24 md:p-2  md:grid md:place-items-center">
            <img
              className="h-full w-full object-contain"
              loading="lazy"
              alt="category-picture"
